DB_NOMBRE_DEL_DUMP= ~/Dropbox/Trabajo/SaMDB/backups/samdb_backup_`date +'%Y%m%d_%Hhs%Mmin'`.dump
DB_DUMP_MAS_RECIENTE=`ls -Art ~/Dropbox/Trabajo/SaMDB/backups/samdb_*.dump  | tail -n 1`
NOMBRE_BD=samdb
...
crear_usuario_admin:
	@pipenv run python scripts/reiniciar_contrasenias.py
